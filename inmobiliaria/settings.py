...
LANGUAGE_CODE = 'es-mx'  # Set to Spanish (Mexico)

TIME_ZONE = 'America/Mexico_City'  # Set to Mexico City timezone
...
LOGIN_URL = 'login'  # The login page URL name
